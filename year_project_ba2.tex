...
\begin{figure}
%\centering
\includegraphics[scale=1]{Diagrammes_ClassDiagram.png}
...
\begin{figure}
%\centering
\includegraphics[scale=1]{Diagrammes_SequenceDiagramClassicChessTurn.png}
\caption{Diagramme de classes d'un tour de jeu}
\label{CD} %ClassDiagram
\end{figure}
