...
\item "<plus grand message actuel: envoi du plateau, 98 bytes max (taille ridicule)"> à formuler
\end{enumerate}
...
\textbf{Protocole :} Le message est composé de string de 3 caractères chacun. Le premier caractère est une lettre désignant le type de la pièce considérée. Les 2 autres, sa position, en commençant par la colonne, selon la réprésentation classique d'un échiquier, c'est à dire, les rangées sont numérotées de 1 à 9 et les colonnes de "A" à "H". Les pions blancs sont séparés des noirs par '!' et à la fin des pions noirs, on ajoute un '#'. Exemple : pA2hA4rD5qC7kE1bF8!bA8qG4kD7#    
