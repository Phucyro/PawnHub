...
Voici le déroulement de la partie représenté à l'aide d'un sequence diagram : \\
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.5]{SequenceDiagramMatchmaking.PNG}
...
\paragraph{}Le jeu d'échec classique, où le but est de mettre le roi adverse en échec sans qu'il ai la possibilité au tour suivant de ne plus l'être.
