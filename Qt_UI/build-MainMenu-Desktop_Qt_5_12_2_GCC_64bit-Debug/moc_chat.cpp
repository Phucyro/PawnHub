...
QT_MOC_LITERAL(7, 131, 11), // "displayChat"
QT_MOC_LITERAL(8, 143, 11), // "std::string"
QT_MOC_LITERAL(9, 155, 6) // "target"
    ...
    "setupChat\0displayChat\0std::string\0"
    "target"
};
...
void Chat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->displayChat((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
