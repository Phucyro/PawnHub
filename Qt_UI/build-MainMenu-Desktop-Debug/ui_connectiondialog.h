...
public:
    ...
    {
        ConnectionDialog->setWindowTitle(QApplication::translate("ConnectionDialog", "Connection", 0, QApplication::UnicodeUTF8));
        hostnameLabel->setText(QApplication::translate("ConnectionDialog", "<html><head/><body><p align=\"center\">Please enter your local server's hostname:</p></body></html>", 0, QApplication::UnicodeUTF8));
        cancelPush->setText(QApplication::translate("ConnectionDialog", "Cancel", 0, QApplication::UnicodeUTF8));
        donePush->setText(QApplication::translate("ConnectionDialog", "Done", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
