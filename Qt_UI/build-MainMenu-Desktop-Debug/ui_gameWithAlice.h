...
public:
    ...
    void setupUi(QDialog *GameWithAlice)
    {
        ...
        verticalLayoutWidget_2->setGeometry(QRect(1050, 80, 114, 101));
        ...
        chgUpdateLabel = new QLabel(GameWithAlice);
        chgUpdateLabel->setObjectName(QString::fromUtf8("chgUpdateLabel"));
        chgUpdateLabel->setGeometry(QRect(1060, 240, 101, 61));
    ...
    {
        GameWithAlice->setWindowTitle(QApplication::translate("GameWithAlice", "Alice Chess", 0, QApplication::UnicodeUTF8));
        imageLabel->setText(QString());
        takenLabel->setText(QApplication::translate("GameWithAlice", "TAKEN :", 0, QApplication::UnicodeUTF8));
        chgTakenLabel->setText(QApplication::translate("GameWithAlice", "PQBR", 0, QApplication::UnicodeUTF8));
        modeLabel->setText(QApplication::translate("GameWithAlice", "<html><head/><body><p>MODE:</p></body></html>", 0, QApplication::UnicodeUTF8));
        chgModelabel->setText(QApplication::translate("GameWithAlice", "mode", 0, QApplication::UnicodeUTF8));
        colourLabel->setText(QApplication::translate("GameWithAlice", "<html><head/><body><p>COLOUR:</p></body></html>", 0, QApplication::UnicodeUTF8));
        chgColourLabel->setText(QApplication::translate("GameWithAlice", "colour", 0, QApplication::UnicodeUTF8));
        lastMoveLabel->setText(QApplication::translate("GameWithAlice", "LAST MOVE:", 0, QApplication::UnicodeUTF8));
        chgLastMovelabel->setText(QApplication::translate("GameWithAlice", "last move", 0, QApplication::UnicodeUTF8));
        opponentNameLabel->setText(QApplication::translate("GameWithAlice", "OPPONENT NAME:", 0, QApplication::UnicodeUTF8));
        chgOpponentNamelabel->setText(QApplication::translate("GameWithAlice", "opponent", 0, QApplication::UnicodeUTF8));
        surrendButton->setText(QApplication::translate("GameWithAlice", "Surrend", 0, QApplication::UnicodeUTF8));
        timeLabel->setText(QApplication::translate("GameWithAlice", "Time:", 0, QApplication::UnicodeUTF8));
        chgTimeLabel->setText(QApplication::translate("GameWithAlice", "0:00", 0, QApplication::UnicodeUTF8));
        checkUpdatelabel->setText(QApplication::translate("GameWithAlice", "TURN:", 0, QApplication::UnicodeUTF8));
        turnLabel->setText(QApplication::translate("GameWithAlice", "Black", 0, QApplication::UnicodeUTF8));
        takenEnnemyLabel->setText(QApplication::translate("GameWithAlice", "TAKEN :", 0, QApplication::UnicodeUTF8));
        chgTakenEnnemyLabel->setText(QApplication::translate("GameWithAlice", "PQBR", 0, QApplication::UnicodeUTF8));
        sendPushButton->setText(QApplication::translate("GameWithAlice", "Send", 0, QApplication::UnicodeUTF8));
