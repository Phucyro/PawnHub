...
public:
    ...
    void setupUi(QDialog *StatisticsTab)
    {
        ...
        staisticsTableWidget->setGridStyle(Qt::SolidLine);
        staisticsTableWidget->setWordWrap(true);
        staisticsTableWidget->setCornerButtonEnabled(true);
        staisticsTableWidget->horizontalHeader()->setCascadingSectionResizes(false);
        staisticsTableWidget->horizontalHeader()->setDefaultSectionSize(130);
