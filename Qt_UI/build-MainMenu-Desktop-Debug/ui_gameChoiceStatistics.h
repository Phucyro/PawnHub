...
public:
    ...
    {
        GameChoiceStatistics->setWindowTitle(QApplication::translate("GameChoiceStatistics", "Game Types", 0, QApplication::UnicodeUTF8));
        label->setText(QString());
        classicPushButton->setText(QApplication::translate("GameChoiceStatistics", "Classic", 0, QApplication::UnicodeUTF8));
        darkPushButton->setText(QApplication::translate("GameChoiceStatistics", "Dark", 0, QApplication::UnicodeUTF8));
        hordePushButton->setText(QApplication::translate("GameChoiceStatistics", "Horde", 0, QApplication::UnicodeUTF8));
        alicePushButton->setText(QApplication::translate("GameChoiceStatistics", "Alice", 0, QApplication::UnicodeUTF8));
        realTimeClassicPushButton->setText(QApplication::translate("GameChoiceStatistics", "RealTime Classic", 0, QApplication::UnicodeUTF8));
        realTimeDarkPushButton->setText(QApplication::translate("GameChoiceStatistics", "RealTime Dark", 0, QApplication::UnicodeUTF8));
        realTimeHordePushButton->setText(QApplication::translate("GameChoiceStatistics", "RealTime Horde", 0, QApplication::UnicodeUTF8));
        realTimeAlicePushButton->setText(QApplication::translate("GameChoiceStatistics", "RealTime Alice", 0, QApplication::UnicodeUTF8));
        returnPushButton->setText(QApplication::translate("GameChoiceStatistics", "Return", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
