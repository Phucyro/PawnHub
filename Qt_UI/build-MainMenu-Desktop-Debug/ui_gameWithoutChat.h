...
public:
    ...
    void setupUi(QDialog *GameWithoutChat)
    {
        ...
        moveConfirmButton = new QPushButton(GameWithoutChat);
        moveConfirmButton->setObjectName(QString::fromUtf8("moveConfirmButton"));
        moveConfirmButton->setEnabled(false);
        moveConfirmButton->setGeometry(QRect(690, 420, 80, 25));
        moveConfirmButton->setFlat(false);
    ...
    void retranslateUi(QDialog *GameWithoutChat)
    {
        ...
        turnLabel->setText(QApplication::translate("GameWithoutChat", "TURN:", nullptr));
        chgTurnLabel->setText(QApplication::translate("GameWithoutChat", "Black", nullptr));
        ...
        moveConfirmButton->setText(QApplication::translate("GameWithoutChat", "Done", nullptr));
    } // retranslateUi
