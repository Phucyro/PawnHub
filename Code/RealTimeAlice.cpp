...
bool RealTimeAlice::_canFight(Piece* p1, Piece* p2, Coordinate end){
	return RealTimeGame::_canFight(p1, p2, end) && dynamic_cast<AlicePiece*>(p1)->getDimension() == dynamic_cast<AlicePiece*>(p2)->getDimension();
}
