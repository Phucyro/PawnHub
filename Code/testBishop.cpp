...
void TestBishop :: testMove()
{
  ...
  CPPUNIT_ASSERT(board->getCase(Coordinate('B','2')) == bishopA); //checks if bishopA is in B2
  ...
  CPPUNIT_ASSERT(board->getCase(Coordinate('B','1')) == bishopB); //checks if bishopB is in B1
  CPPUNIT_ASSERT(board->getCase(Coordinate('C','2')) == bishopC); //checks if bishopC is in C2
  ...
  CPPUNIT_ASSERT(board->getCase(Coordinate('G','7')) == nullptr); //checks if bishopE is not in G7
  CPPUNIT_ASSERT(board->getCase(Coordinate('E','2')) == bishopE); //checks if bishopE is in E2

  //good move
  CPPUNIT_ASSERT_EQUAL(bishopH->move(Coordinate('A','5'), board, *game), true); // make bishopA move to A5
  CPPUNIT_ASSERT(board->getCase(Coordinate('A','5')) == bishopH); //checks if bishopH is in A5
  CPPUNIT_ASSERT(board->getCase(Coordinate('C','7')) == nullptr); //checks if bishopH is not in C7
  ...
  CPPUNIT_ASSERT(board->getCase(Coordinate('G','3')) == bishopI); //checks if bishopH is in G3
  CPPUNIT_ASSERT(board->getCase(Coordinate('H','2')) == nullptr); //checks if bishopH is not in H2
  ...
  CPPUNIT_ASSERT(board->getCase(Coordinate('G','5')) == bishopJ); //checks if bishopJ is in G5
  CPPUNIT_ASSERT(board->getCase(Coordinate('E','7')) == nullptr); //checks if bishopJ is not in E7
  ...
  CPPUNIT_ASSERT(board->getCase(Coordinate('D','6')) == bishopL); //checks if bishopL is in D6
  ...
  CPPUNIT_ASSERT(board->getCase(Coordinate('E','4')) == bishopF); //checks if bishopF is in E4
